<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./"><img src="../db/small-logo-icon.png" alt="Logo"> V-CARE</a>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="service-request-status.php">|<i class="fa fa-wrench"></i>| Service Request Status</a></li>
                <li><a href="service-info.php">|<i class="fa fa-info"></i>| Vehicle Service Status</a></li>

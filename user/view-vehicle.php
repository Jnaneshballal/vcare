                ...
                <aside class="profile-nav alt">
                    <section class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <button type="button" class="btn btn-danger mb-1" data-toggle="modal" data-target="#staticModal" style="border-radius:50px;text-align:center;">
                                    <i class="fa fa-trash"></i>
                                </button>
                                <!-- <a href="#"><span class="badge badge-warning pull-right r-activity">Edit<i class="fa fa-edit"></i></span></a> -->
                                <button type="button" class="btn btn-warning pull-right mb-1" data-toggle="modal" data-target="#mediumModal" style="border-radius:50px;text-align:center;">
